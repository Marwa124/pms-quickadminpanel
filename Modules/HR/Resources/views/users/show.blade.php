...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#department_head_deparrtments" role="tab" data-toggle="tab">
    ...
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="department_head_deparrtments">
            @includeIf('admin.users.relationships.departmentHeadDeparrtments', ['deparrtments' => $user->departmentHeadDeparrtments])
        </div>
