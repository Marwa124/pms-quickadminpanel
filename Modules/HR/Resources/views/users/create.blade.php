    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('marketting_username') ? 'is-invalid' : '' }}" type="text" name="marketting_username" id="marketting_username" value="{{ old('marketting_username', '') }}">
