    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.projects.update", [$project->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('progress') ? 'is-invalid' : '' }}" type="text" name="progress" id="progress" value="{{ old('progress', $project->progress) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('calculate_progress') ? 'is-invalid' : '' }}" type="text" name="calculate_progress" id="calculate_progress" value="{{ old('calculate_progress', $project->calculate_progress) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('actual_completion') ? 'is-invalid' : '' }}" type="text" name="actual_completion" id="actual_completion" value="{{ old('actual_completion', $project->actual_completion) }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Project::NOTIFY_CLIENT_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('notify_client') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="notify_client_{{ $key }}" name="notify_client" value="{{ $key }}" {{ old('notify_client', $project->notify_client) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Project::TIMER_STATUS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('timer_status') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="timer_status_{{ $key }}" name="timer_status" value="{{ $key }}" {{ old('timer_status', $project->timer_status) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('timer_started_by') ? 'is-invalid' : '' }}" type="number" name="timer_started_by" id="timer_started_by" value="{{ old('timer_started_by', $project->timer_started_by) }}" step="1">
            ...
            <div class="form-group">
                <label for="start_time">{{ trans('cruds.project.fields.start_time') }}</label>
                <input class="form-control timepicker {{ $errors->has('start_time') ? 'is-invalid' : '' }}" type="text" name="start_time" id="start_time" value="{{ old('start_time', $project->start_time) }}">
                @if($errors->has('start_time'))
                    <div class="invalid-feedback">
                        {{ $errors->first('start_time') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.project.fields.start_time_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="logged_time">{{ trans('cruds.project.fields.logged_time') }}</label>
                <input class="form-control timepicker {{ $errors->has('logged_time') ? 'is-invalid' : '' }}" type="text" name="logged_time" id="logged_time" value="{{ old('logged_time', $project->logged_time) }}">
                @if($errors->has('logged_time'))
                    <div class="invalid-feedback">
                        {{ $errors->first('logged_time') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.project.fields.logged_time_helper') }}</span>
            </div>
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('premissions') ? 'is-invalid' : '' }}" name="premissions[]" id="premissions" multiple>
                    @foreach($premissions as $id => $premissions)
                        <option value="{{ $id }}" {{ (in_array($id, old('premissions', [])) || $project->premissions->contains($id)) ? 'selected' : '' }}>{{ $premissions }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <label for="hourly_rate">{{ trans('cruds.project.fields.hourly_rate') }}</label>
                <input class="form-control {{ $errors->has('hourly_rate') ? 'is-invalid' : '' }}" type="text" name="hourly_rate" id="hourly_rate" value="{{ old('hourly_rate', $project->hourly_rate) }}">
                @if($errors->has('hourly_rate'))
                    <div class="invalid-feedback">
                        {{ $errors->first('hourly_rate') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.project.fields.hourly_rate_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="fixed_rate">{{ trans('cruds.project.fields.fixed_rate') }}</label>
                <input class="form-control {{ $errors->has('fixed_rate') ? 'is-invalid' : '' }}" type="text" name="fixed_rate" id="fixed_rate" value="{{ old('fixed_rate', $project->fixed_rate) }}">
                @if($errors->has('fixed_rate'))
                    <div class="invalid-feedback">
                        {{ $errors->first('fixed_rate') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.project.fields.fixed_rate_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="project_settings">{{ trans('cruds.project.fields.project_settings') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('project_settings') ? 'is-invalid' : '' }}" name="project_settings" id="project_settings">{!! old('project_settings', $project->project_settings) !!}</textarea>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Project::WITH_TASKS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('with_tasks') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="with_tasks_{{ $key }}" name="with_tasks" value="{{ $key }}" {{ old('with_tasks', $project->with_tasks) === (string) $key ? 'checked' : '' }} required>
