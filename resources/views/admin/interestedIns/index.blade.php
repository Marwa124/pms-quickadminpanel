...
@can('interested_in_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.interested-ins.create') }}">
                        ...
                        <tr data-entry-id="{{ $interestedIn->id }}">
                            ...
                            <td>
                                ...
                                @can('interested_in_delete')
                                    <form action="{{ route('admin.interested-ins.destroy', $interestedIn->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('interested_in_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.interested-ins.massDestroy') }}",
