...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.job-circulars.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vacancy_no') ? 'is-invalid' : '' }}" type="text" name="vacancy_no" id="vacancy_no" value="{{ old('vacancy_no', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('employment_type') ? 'is-invalid' : '' }}" name="employment_type" id="employment_type" required>
                    ...
                    @foreach(App\Models\JobCircular::EMPLOYMENT_TYPE_SELECT as $key => $label)
